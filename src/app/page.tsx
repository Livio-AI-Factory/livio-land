    ...
    <div>
      ...
      <section className="bg-slate-50">
        <div className="mx-auto max-w-7xl px-4 py-16 grid gap-8 md:grid-cols-2">
          <div className="rounded-2xl bg-white border-2 border-brand-200 p-8 shadow-sm">
            <span className="inline-block rounded-full bg-brand-50 px-2 py-0.5 text-xs font-semibold uppercase tracking-wide text-brand-700">
              Primary
            </span>
